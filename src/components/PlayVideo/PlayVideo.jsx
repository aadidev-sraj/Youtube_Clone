...
const PlayVideo = ({videoId}) => {
  return (
    <div className='play-video'>
        ...
        <h3>Kadalkaakakkal parakkunu</h3>
        <div className="play-video-info">
            <p>1523 viewss &bull; 2 days ago</p>
            <div>
                <span><img src={like} alt="" />125</span>
                <span><img src={dislike} alt="" />155</span>
        ...
        <div className="vid-description">
            ...
            <div className="comment">
                ...
                <div>
                    <h3>Jack Sasi <span>1 day ago</span></h3>
                    <p>Those who watched this said in the same tone ... </p>
